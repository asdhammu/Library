...
public class NERDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String propFile = "C://Users/asdha/workspace/DBProject/Library/LibraryManagement/src/main/java/com/library/main/english.all.3class.distsim.prop";
    ...
    AbstractSequenceClassifier<CoreLabel> classifier = CRFClassifier.getClassifier(new File(serializedClassifier));//getJarClassifier(serializedClassifier, prop);//getClassifier(serializedClassifier);
    ...
    */
    ...
    if (args.length > 1) {
      ...
      */
      ...
      String[] example = {"charles dickens"};
